---
title: "How To Optimise Analytics In A Redis Cluster"
date: 2024-02-02
tags: ["Analytics", "Distributed Analytics", "Redis", "Redis Shards", "analytics_config.enable_multiple_analytics_keys" ]
description: "Explains how to reduce CPU usage in a Redis Cluster by configuring Tyk to use a Redis Cluster to distribute analytics keys to multiple Redis Shards"
---
...
{{< img src="/img/faq/enable-multiple-analytics-keys/redis_single.png" width="768" >}}
...
In Redis, *key sharding* is a term used to describe the practice of distributing data across multiple Redis servers or *shards* based on the keys. This feature is provided by [Redis Cluster](https://redis.io/docs/management/scaling/) and provides horizontal scalability and improved performance. 
...
{{< img src="/img/faq/enable-multiple-analytics-keys/redis_distributed.png" width="768" >}}

This section explains how to configure Tyk to distribute analytics keys across multiple Redis shards.

## Pre-requisites

Before continuing, check that your Redis Cluster is correctly configured.
...
## Configure Tyk To Distribute Analytics Keys To Multiple Redis Shards
