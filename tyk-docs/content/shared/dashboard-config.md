...
### redis_ssl_ca_file
ENV: <b>TYK_DB_REDISSSLCAFILE</b><br />
Type: `string`<br />

Redis SSL CA File

### redis_ssl_cert_file
ENV: <b>TYK_DB_REDISSSLCERTFILE</b><br />
Type: `string`<br />

Redis SSL Cert file

### redis_ssl_key_file
ENV: <b>TYK_DB_REDISSSLKEYFILE</b><br />
Type: `string`<br />

Redis SSL Key file

### redis_ssl_max_version
ENV: <b>TYK_DB_REDISSSLMAXVERSION</b><br />
Type: `string`<br />

Redis SSL Max version

### redis_ssl_min_version
ENV: <b>TYK_DB_REDISSSLMINVERSION</b><br />
Type: `string`<br />

Redis SSL Min version
